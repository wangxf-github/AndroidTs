package com.mobile.device.manage.download.database;

import android.content.ContentValues;
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;
import android.util.Log;
import com.mobile.device.manage.download.Utils.helper.SqlString;
...
import com.mobile.device.manage.download.database.constants.TABLES;
import com.mobile.device.manage.download.database.constants.TASKS;
