package com.mobile.device.manage.download.core;

import android.content.Context;
import android.os.Environment;
import android.util.Log;
import com.mobile.device.manage.download.Utils.helper.FileUtils;
import com.mobile.device.manage.download.core.chunkWorker.Moderator;
import com.mobile.device.manage.download.core.enums.QueueSort;
import com.mobile.device.manage.download.core.enums.TaskStates;
import com.mobile.device.manage.download.core.mainWorker.AsyncStartDownload;
import com.mobile.device.manage.download.core.mainWorker.QueueModerator;
import com.mobile.device.manage.download.database.ChunksDataSource;
import com.mobile.device.manage.download.database.DatabaseHelper;
import com.mobile.device.manage.download.database.TasksDataSource;
...
import com.mobile.device.manage.download.report.exceptions.QueueDownloadInProgressException;
import com.mobile.device.manage.download.report.exceptions.QueueDownloadNotStartedException;
import com.mobile.device.manage.download.report.listener.DownloadManagerListener;
import com.mobile.device.manage.download.report.listener.DownloadManagerListenerModerator;
